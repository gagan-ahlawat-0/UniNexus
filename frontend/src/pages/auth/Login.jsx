              ...
              >
                <div className="w-full h-full bg-gradient-to-t from-slate-900/80 dark:from-[#130f24] via-transparent to-transparent flex flex-col justify-end p-10">
                  <h2 className="text-4xl font-bold leading-tight mb-4 text-white">
                    Empowering the next generation of campus leaders.
                  </h2>
                  <p className="text-slate-200 dark:text-slate-400 text-lg max-w-md">
                    The unified engagement platform for over 500+ student organizations and 20,000+ active students.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full max-w-[440px]">
            ...
            <div className="flex flex-col items-center lg:items-start mb-10">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-lg">
                  Sign in to your UniNexus account to explore campus life.
                </p>
              </div>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between py-1">
                ...
                <Link
                  to="/forgot-password"
                  className="text-sm font-semibold text-primary hover:text-primary-dark dark:hover:text-primary hover:underline underline-offset-4 transition-colors"
                >
                  Forgot Password?
                </Link>
              </div>
